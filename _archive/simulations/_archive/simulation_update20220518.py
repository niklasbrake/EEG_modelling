...
fE = lambda t,L: 1.5-0.5*(np.sin(2*np.pi*t*10/1000)) # Timofeev, Grenier, and Steriade(2001)
...
for rep in range(nReps):
    ...
    # savePath = 'E:/Research_Projects/004_Propofol/Modelling/neuron_simulations/data/simulations/before_after_propofol/2022_05_17 parameters/'
    savePath = 'E:/Research_Projects/004_Propofol/Modelling/neuron_simulations/data/simulations/cortical_column/propofol/'
