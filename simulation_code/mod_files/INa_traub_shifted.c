...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 inaT C:/Users/brake/Documents/GitHub/aperiodic_EEG_modelling/simulations/functions/mod_files/INa_traub_shifted.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "INa_traub_shifted.mod";
static const char* nmodl_file_text = 
