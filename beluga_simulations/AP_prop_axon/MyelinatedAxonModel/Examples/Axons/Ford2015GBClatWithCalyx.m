function par = Ford2015GBClatWithCalyx()
...
par.node.seg.geo.diam.value.vec(51, 1) =                                2.04;
par.node.seg.geo.diam.value.vec(51, 2:11) =                             2.7;
par.node.seg.geo.diam.value.vec(51, 12:end) =                           10;
par.node.seg.geo.length.value.vec(51, 1) =                              2.13;
par.node.seg.geo.length.value.vec(51, 2:11) =                           13.22/10;
par.node.seg.geo.length.value.vec(51, 12:end) =                         1700/(50*pi*10);
...
par.myel.geo.numlamellae.value.vec(:) =                                 31;
