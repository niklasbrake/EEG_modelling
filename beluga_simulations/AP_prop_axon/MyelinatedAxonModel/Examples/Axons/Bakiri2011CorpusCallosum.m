function par = Bakiri2011CorpusCallosum()
...
% Node geometry
% Node diameter.
par.node.geo.diam.value.ref =                                           0.36;
...
% Value of 12nm used to give a number of myelin wraps = 5.
